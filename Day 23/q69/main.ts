...
function divideAndRemainder(dividend: number, dividsor: number): {quotient: number, remainder: number} {
...
function divAndRemainder(div: number, dividsor: number): {quoti: number, remainder: number} {
